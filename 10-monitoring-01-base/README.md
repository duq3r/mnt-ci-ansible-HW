...
Идея, что портят метрику только 500-е и 400е коды. Их отсутствие, т.е. все 200е = 100% отнимаем процент плохих кодов и получаем метрику SLI (Реальные цифры доступности нашего продукта). 
