...
В формуле не учли ответ 1xx (Информационные) и 3хх (Редиректы), которые тоже можно считать хорошими ответами. <br>
```
SLI = (summ_3xx_requests + summ_2xx_requests  + summ_1xx_requests)  / summ_all_requests
```  